        ...
        fluidRow(
          column(
            ...
            selectInput(
              ...
              'CI/CD Enabled',
              choices = c('Yes', 'No'),
              selected = ifelse(is.null(hold), "", hold$cyl)
            ),
            selectInput(
              ns('disp'),
              'AI Enabled',
              choices = c('Yes', 'No'),
              selected = ifelse(is.null(hold), "", hold$disp)
            ),
            numericInput(
              ns('hp'),
              'NPS',
          ...
          column(
            ...
            selectInput(
              ...
              choices = c('Domino', 'Java'),
              selected = ifelse(is.null(hold), "", hold$vs)
            ),
            selectInput(
              ns('am'),
              'Home Grown or Thrid Party',
              choices = c('Home Grown', 'Third Party'),
              selected = ifelse(is.null(hold), "", hold$am)
            ),
            numericInput(
              ns('gear'),
              'Months Since Deploy Date',
